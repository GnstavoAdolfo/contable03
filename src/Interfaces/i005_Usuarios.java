 ...
 */
public class i005_Usuarios extends javax.swing.JFrame {

    /**
     * Creates new form i003_Empresas
     */
    public i005_Usuarios() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "DNI", "Nombre", "Usuario", "Clave", "RUC", "Razon Social"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(i005_Usuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new i005_Usuarios().setVisible(true);
            }
        });
    }
